...
class PostgresConn
{
    ...
    private function __construct()
    {
        ...
        $this->host = Environment::get('PG_HOST', 'localhost');
        $this->database = Environment::get('PG_DATABASE', 'tickflow');
        $this->username = Environment::get('PG_USERNAME', 'postgres');
        $this->password = Environment::get('PG_PASSWORD', '');
        $this->port = Environment::get('PG_PORT', '5432');
    ...
    private function connect()
    {
        try {
            ...
            // Definir charset UTF8 para PostgreSQL
            $this->connection->exec("SET NAMES 'UTF8'");
            
        } catch (PDOException $e) {
            throw new Exception("Erro na conexão com o banco de dados PostgreSQL: " . $e->getMessage());
        }
    }
    ...
    public function getDatabaseInfo()
    {
        try {
            ...
            $charset = $this->connection->query("SHOW SERVER_ENCODING")->fetch();
            ...
            return [
                ...
                'charset' => $charset['server_encoding'] ?? 'UTF8'
            ];
        } catch (Exception $e) {
            return [
                'error' => $e->getMessage()
